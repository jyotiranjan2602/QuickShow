...
const Dashboard = () => {
    ...
    const[dashboardData, setDashboardDdata] = useState({
        totalBookings:0,
        totalRevenue:0,
        activeShows:[],
        totalUser:0
    ...
    const dashboardCards = [
        {title:'TotalBookings', value:dashboardData.totalBookings || "0", icon: ChartLineIcon},
    ...
    <>
      ...
      <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
            ...
            {dashboardData.activeShows.map((show)=>(
                <div key={show} className='w-55 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20
