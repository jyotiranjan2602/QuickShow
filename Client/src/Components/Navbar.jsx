...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
        ...
        bg-black/70 md:bg-white/20 md:border border-gray-300/20 overflow-hidden transition-[width] duration-300
        ...
        <MenuIcon className='max-md:ml-2 md:hidden w-8 h-8 cursor-pointer' onClick={()=>setIsOpen(!isOpen)}/>
    </div>
  )
}
