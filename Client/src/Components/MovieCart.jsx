...
const MovieCart = ({movie}) => {
  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 duration-100 w-66'>
      <img src={movie.backdrop_path} alt='' 
       className='rounded-lg h-35 w-full object-cover onject-right-bottom cursor-pointer'
